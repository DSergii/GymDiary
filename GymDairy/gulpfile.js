...
var bc = './bower_components/';
	...
	gulp.task('watch', function() {
		gulp.watch('development/app/**/*', ['app']);
	...
	gulp.task('libs', function() {
		...
		.pipe(gulp.dest('./development/libs/jquery/'));
		
		gulp.src(bc+'bootstrap/dist/**/*.*')
		.pipe(gulp.dest('./development/libs/bootstrap/'));
		
		gulp.src(bc+'bootstrap-material-design/dist/**/*.*')
		.pipe(gulp.dest('./development/libs/bootstrap-material-design/'));
		...
		.pipe(gulp.dest('./development/libs/angular/'));
	});
